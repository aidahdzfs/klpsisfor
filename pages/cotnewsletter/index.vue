    ...
    <main class="overflow-x-hidden">
        ...
        <section class="pt-24">
            <div class="h-[202px] relative">
                ...
                <div class="w-[474px] h-[45px] relative top-20 left-20">
                    <a href="#" class="w-[302px] h-[45px] left-[172px] absolute text-slate-300 text-2xl font-semibold">COT Newsletter</a>
        ...
        <section class="py-8 my-10 ml-28">
            <div class="font-semibold pr-[155px] text-justify leading-relaxed">
                <p class="mb-5"><span class="font-black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CoT News Letter</span> merupakan salah satu media komunikasi mengenai jejak langkah aktivitas CoT sejak awal pembentukan hingga perkembangan sejalan waktu. Media ini memberikan informasi berkala mengenai hal-hal terkait tentang berita dan kegiatan oleh Center of Technology. CoT News Letter diterbitkan dan dikelola oleh Divisi Promosi Keteknikan, Center of Technology, Fakultas Teknik, Universitas Hasanuddin.</p>
                <p class="">File CoT News Letter dapat diunduh di sini: <span class="text-sky-700 hover:text-navy"><a href="https://cot.unhas.ac.id/newsletter">http://cot.unhas.ac.id/newsletter</a></span></p>
            </div>
        </section>
    </main>
</template>