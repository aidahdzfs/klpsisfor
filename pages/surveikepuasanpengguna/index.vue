        ...
        <section class="pt-24">
            <div class="h-[202px] relative">
                ...
                <div class="w-[474px] h-[45px] relative top-20 left-20">
                    <a href="#" class="w-[302px] h-[44px] left-[172px] absolute text-slate-300 text-2xl semibold">Survei Kepuasan Pengguna</a>
        ...
        <section class="my-10 py-8 mr-[155px] ml-28">
            <div>
                ...
                <ul class="leading-relaxed list-outside list-decimal text-left space-y-3 text-sm ml-4 mt-4">
                    ...
                    <li>Peraturan Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Republik Indonesia No. 15 Tahun 2014 tentang Pedoman Standar Pelayanan</li>
                    <li>Peraturan Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Republik Indonesia No. 16 Tahun 2014 tentang Pedoman Survei Kepuasan Masyarakat terhadap PenyeIenggaraan Pelayanan Publik</li>
                ...
                <ul class="list-outside list-decimal text-left space-y-3 text-sm ml-4 mt-4">
                    ...
                    <ul class="list-outside list-disc text-left space-y-3 text-sm ml-4 mt-4">
                        ...
                        <li>Gugus Penjaminan Mutu menyampaikan hasil monitoring pelaksanaan pelayanan akademik kepada Dekan.</li>
