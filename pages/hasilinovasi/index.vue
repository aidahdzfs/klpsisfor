<template>
    <main class="overflow-x-hidden">
        ...
        <section class="pt-24">
            <div class="h-[202px] relative">
                ...
                <div class="w-[474px] h-[45px] relative top-20 left-20">
                    <a href="#" class="w-[302px] h-[45px] left-[172px] absolute text-slate-300 text-2xl font-semibold">Hasil Inovasi</a>
        ...
        <section class="mt-10 py-8">
            <div id="hasilinovasi">
                <div v-for="item in inovasiData" :key="item.id" class="pb-20">
                    ...
                    <p class=" px-80 text-xl" v-html="item.isi"></p>
                </div>
            </div>
        </section>
    </main>
...
<script setup>
    ...
    const endpoint = "http://localhost:8055/items/hasilinovasi"
    const inovasiData = ref('');

    async function getInovasi() {
